...
function createStyles(C: AliasedColors) {
  return StyleSheet.create({
    ...
    contactDesc: { fontSize: 12, color: C.text2 },
    ...
    faqArrow: { fontSize: 10, color: C.text3 },
    faqA: { fontSize: 12, color: C.text2, lineHeight: 18, marginTop: 10 },
    ...
    hoursDesc: { fontSize: 12, color: C.text2, marginBottom: 2 },
  });
}
        ...
        <View style={styles.section}>
          <View style={styles.hoursCard}>
            ...
            <View>
              ...
              <Text style={[styles.hoursDesc, { color: C.text3 }]}>
                Pazar: Kapalı
              </Text>
            </View>
          </View>
